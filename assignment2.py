...
def sentiment_analysis():
    """conducts sentiment analysis on 20 most common words"""
    common_words = ['mr','elizabeth','will','said','darcy','mrs','much','must','bennet','miss','one','jane','bingley','know','though','well','never','soon','think','can']
...
def main():
    ...
    print("Sentiment scoring on the 20 most common words in the text are as follows:", sentiment_analysis())
